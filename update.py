...
conn=py.connect(user='root',password='amangupta',host='localhost',database='store')
c=conn.cursor()
...
class Database:
    ...
    def __init__(self, master, *args, **kwargs):
        ...
        self.master = master
        self.haeding = Label(master, text="UPDATE THE DATABASE", font='ariel 18 bold', fg='steelblue')
    ...
    def update(self,*args,**kwargs):
        ...
        query='UPDATE inventory SET name=%s,stock=%s,cp=%s,sp=%s,vendor=%s,vendorphn=%s where id=%s'
